...
RUN apk update && apk upgrade && apk add curl tar make gcc build-base wget gnupg libev libev-dev libressl libressl-dev mariadb-dev mariadb-client mariadb-libs mysql-client bash nodejs-npm
